...
<!------------------------------------------------>		
			...
			<?php
				...
				$resultip = mysql_query("select configurations.ip, amps.description from configurations, amps where configurations.description='$description' and configurations.dwdm='$dwdm' and configurations.ip=amps.ip order by number");
				...
				echo "</table><br>";
				/*
				echo "<form method=post action=edit_conf.php>
						<input type=hidden name=description value=$description>
						<input type=hidden name=dwdm value=$dwdm>
						<input type=submit value='Редактировать конфигурацию'>
					</form><br>";
				
				echo "<form method=post action=edit_conf_number.php>
						<input type=hidden name=description value=$description>
						<input type=hidden name=dwdm value=$dwdm>
						<input type=submit value='Изменить порядок усилителей'>
					</form>";
				*/
